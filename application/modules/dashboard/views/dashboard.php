			...
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-4 col-md-4 col-12 wow fadeInUp" data-wow-delay="0.4s">
						...
						<div class="single-feature">
							<div class="feature-head">
								<img src="<?= base_url('')?>assets1/images/feature1.jpg" alt="#">
							</div>
					...
					<div class="col-lg-4 col-md-4 col-12 wow fadeInUp" data-wow-delay="0.6s">
						...
						<div class="single-feature">
							<div class="feature-head">
								<img src="<?= base_url('')?>assets1/images/feature2.jpg" alt="#">
							</div>
					...
					<div class="col-lg-4 col-md-4 col-12 wow fadeInUp" data-wow-delay="0.8s">
						...
						<div class="single-feature">
							<div class="feature-head">
								<img src="<?= base_url('')?>assets1/images/feature3.jpg" alt="#">
							</div>
						...
						<div class="course-slider">
							...
							<div class="single-course">
								<div class="course-head overlay">
									<img src="<?= base_url('')?>assets1/images/course/course1.jpg" alt="#">
							...
							<div class="single-course">
								<div class="course-head overlay">
									<img src="<?= base_url('')?>assets1/images/course/course2.jpg" alt="#">
									<a href="course-single.html" class="btn"><i class="fa fa-link"></i></a>
								</div>
								<div class="single-content">
							...
							<div class="single-course">
								<div class="course-head overlay">
									<img src="<?= base_url('')?>assets1/images/course/course3.jpg" alt="#">
									<a href="course-single.html" class="btn"><i class="fa fa-link"></i></a>
								</div>
								<div class="single-content">
				...
				<div class="row">
					<div class="col-lg-3 col-md-6 col-12 wow fadeIn" data-wow-delay="0.4s">
						...
						<div class="single-team">
							<img src="<?= base_url('')?>assets1/images/team/team1.jpg" alt="#">
					...
					<div class="col-lg-3 col-md-6 col-12 wow fadeIn" data-wow-delay="0.6s">
						...
						<div class="single-team active">
							<img src="<?= base_url('')?>assets1/images/team/team2.jpg" alt="#">
							<div class="team-hover">
					...
					<div class="col-lg-3 col-md-6 col-12 wow fadeIn" data-wow-delay="0.8s">
						<!-- Single Team -->
						<div class="single-team">
							<img src="<?= base_url('')?>assets1/images/team/team3.jpg" alt="#">
							<div class="team-hover">
					...
					<div class="col-lg-3 col-md-6 col-12 wow fadeIn" data-wow-delay="1s">
						<!-- Single Team -->
						<div class="single-team">
							<img src="<?= base_url('')?>assets1/images/team/team4.jpg" alt="#">
							<div class="team-hover">
					...
					<div class="col-12">
						<div class="testimonial-slider">
							...
							<div class="single-testimonial">
								<img src="<?= base_url('')?>assets1/images/testimonial1.jpg" alt="#">
							...
							<!-- Single Testimonial -->
							<div class="single-testimonial">
								<img src="<?= base_url('')?>assets1/images/testimonial2.jpg" alt="#">
								<div class="main-content">
							...
							<!-- Single Testimonial -->
							<div class="single-testimonial">
								<img src="<?= base_url('')?>assets1/images/testimonial3.jpg" alt="#">
								<div class="main-content">
									<h4 class="name">Sanavce Faglane</h4>
									<p>Nulla cursus a metus vel placerat. Fusce malesuada volutpat pretium. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus velit libero, viverra quis euismod vel pellentesque at tortor. Donec</p>
								</div>
							...
							<!-- Single Testimonial -->
							<div class="single-testimonial">
								<img src="<?= base_url('')?>assets1/images/testimonial4.jpg" alt="#">
								<div class="main-content">
									<h4 class="name">Jansan Kate</h4>
									<p>Nulla cursus a metus vel placerat. Fusce malesuada volutpat pretium. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus velit libero, viverra quis euismod vel pellentesque at tortor. Donec</p>
								</div>
						...
						<div class="event-slider">
							...
							<div class="single-event">
								<div class="head overlay">
									<img src="<?= base_url('')?>assets1/images/events/event1.jpg" alt="#">
							...
							<div class="single-event">
								<div class="head overlay">
									<img src="<?= base_url('')?>assets1/images/events/event2.jpg" alt="#">
							...
							<div class="single-event">
								<div class="head overlay">
									<img src="<?= base_url('')?>assets1/images/events/event3.jpg" alt="#">
						...
						<div class="blog-slider">
							...
							<div class="single-blog">
								<div class="blog-head overlay">
									...
									<img src="<?= base_url('')?>assets1/images/blog/blog4.jpg" alt="#">
								</div>
								<div class="blog-content">
									<h4 class="blog-title"><a href="blog-single.html">Our Student Have sit amet egestas</a></h4>
									<div class="blog-info">
