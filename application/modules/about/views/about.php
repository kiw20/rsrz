				...
				<div class="row">
					<div class="col-lg-6 col-12">
						<div class="single-image overlay">
							<img src="<?php echo base_url('')?>assets1/images/about.jpg" alt="#">
				...
				<div class="row">
					<div class="col-lg-3 col-md-6 col-12">
						...
						<div class="single-team">
							<img src="<?php echo base_url('')?>assets1/images/team/team1.jpg" alt="#">
					...
					<div class="col-lg-3 col-md-6 col-12">
						...
						<div class="single-team active">
							<img src="<?php echo base_url('')?>assets1/images/team/team2.jpg" alt="#">
							<div class="team-hover">
					...
					<div class="col-lg-3 col-md-6 col-12">
						<!-- Single Team -->
						<div class="single-team">
							<img src="<?php echo base_url('')?>assets1/images/team/team3.jpg" alt="#">
							<div class="team-hover">
					...
					<div class="col-lg-3 col-md-6 col-12">
						<!-- Single Team -->
						<div class="single-team">
							<img src="<?php echo base_url('')?>assets1/mages/team/team4.jpg" alt="#">
							<div class="team-hover">
