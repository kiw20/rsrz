...
<!-- Mirrored from themelamp.com/html/learnedu/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Jan 2020 06:42:17 GMT -->
<head>
		<!-- Meta -->
		<meta charset="utf-8">
		...
		<!-- Favicon -->
		<link rel="icon" type="image/png" href="<?= base_url('')?>assets1/images/favicon.png">
		<!-- Web Font -->
		...
		<!-- Fancy Box CSS -->
        <link rel="stylesheet" href="<?= base_url()?>assets1/css/jquery.fancybox.min.css">
		<!-- Owl Carousel CSS -->
        <link rel="stylesheet" href="<?= base_url()?>assets1/css/owl.carousel.min.css">
        <link rel="stylesheet" href="<?= base_url()?>assets1/css/owl.theme.default.min.css">
		<!-- Animate CSS -->
        <link rel="stylesheet" href="<?= base_url()?>assets1/css/animate.min.css">
		<!-- Slick Nav CSS -->
        <link rel="stylesheet" href="<?= base_url()?>assets1/css/slicknav.min.css">
        <!-- Magnific Popup -->
		...
		<!-- Learedu Color -->
		<link rel="stylesheet" href="<?= base_url('')?>assets1/css/color/color1.css">
    ...
    <body>
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-3 col-md-3 col-12">
							<div class="logo">
								<a href="index-2.html"><img src="<?= base_url('')?>assets1/images/logo.png" alt="#"></a>
							</div>
							...
							<nav class="navbar navbar-default">
								<div class="navbar-collapse">
									...
									<ul id="nav" class="nav menu navbar-nav">
										<li class="active"><a href="<?php echo base_url() ?>Dashboard">Home</a>
										</li>
					...
					<div class="row">
						<div class="col-lg-3 col-md-6 col-12">
							...
							<div class="single-widget about">
								<div class="logo"><a href="#"><img src="<?= base_url('')?>assets1/images/logo2.png" alt="#"></a></div>
        ...
        <script src="<?= base_url('')?>assets1/js/jquery-migrate.min.js"></script>
		<!-- Popper JS-->
        <script src="<?= base_url('')?>assets1/js/popper.min.js"></script>
		<!-- Bootstrap JS-->
        <script src="<?= base_url('')?>assets1/js/bootstrap.min.js"></script>
		<!-- Colors JS-->
        <script src="<?= base_url('')?>assets1/js/colors.js"></script>
		<!-- Jquery Steller JS -->
		<script src="<?= base_url('')?>assets1/js/jquery.stellar.min.js"></script>
		<!-- Particle JS -->
		<script src="<?= base_url('')?>assets1/js/particles.min.js"></script>
		<!-- Fancy Box JS-->
		<script src="<?= base_url('')?>assets1/js/facnybox.min.js"></script>
		<!-- Magnific Popup JS-->
		<script src="<?= base_url('')?>assets1/js/jquery.magnific-popup.min.js"></script>
		<!-- Masonry JS-->
		<script src="<?= base_url('')?>assets1/js/masonry.pkgd.min.js"></script>
		<!-- Circle Progress JS -->
		<script src="<?= base_url('')?>assets1/js/circle-progress.min.js"></script>
		<!-- Owl Carousel JS-->
        <script src="<?= base_url('')?>assets1/js/owl.carousel.min.js"></script>
		<!-- Waypoints JS-->
        <script src="<?= base_url('')?>assets1/js/waypoints.min.js"></script>
		<!-- Slick Nav JS-->
        <script src="<?= base_url('')?>assets1/js/slicknav.min.js"></script>
		<!-- Counter Up JS -->
		<script src="<?= base_url('')?>assets1/js/jquery.counterup.min.js"></script>
		<!-- Easing JS-->
        <script src="<?= base_url('')?>assets1/js/easing.min.js"></script>
		<!-- Wow Min JS-->
        ...
        <script src="<?= base_url('')?>assets1/js/gmaps.min.js"></script>
		<!-- Main JS-->
        <script src="<?= base_url('')?>assets1/js/main.js"></script>
    </body>

<!-- Mirrored from themelamp.com/html/learnedu/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Jan 2020 06:44:46 GMT -->
</html>